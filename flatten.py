...
#################
  ...
  #histograms name
  OS_hists_name = ['OPS_l1_pt','OPS_l1_eta','OPS_l1_phi','OPS_l2_pt','OPS_l2_eta','OPS_l2_phi','OPS_z_pt','OPS_z_eta','OPS_z_phi','OPS_z_mass','OPS_kinematic_region','j1_CvL','j1_CvB','j1_CHEmEF']
  SS_hists_name = ['ttc_l1_pt','ttc_l1_eta','ttc_l1_phi','ttc_l2_pt','ttc_l2_eta','ttc_l2_phi','ttc_mll','ttc_kinematic_region','j1_CvL','j1_CvB','j1_CHEmEF']
  ...
  histos_bins = {
    ...
    OS_hists_name[11]:[20,0,1],
    OS_hists_name[12]:[20,0,1],
    OS_hists_name[13]:[20,0,1],
...
#########################
  if (region == 'validation'):
    ...
    if isMC:
      OS_filters="n_tight_ele==1 && MET_T1Smear_pt > 20 && n_tight_jet > 1 && j1_pt>50 && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_BadPFMuonFilter && OPS_l1_pt>20 && OPS_l2_pt>20 && abs(OPS_l1_eta)<2.4 && abs(OPS_l2_eta)<2.4" 
    #  OS_filters="OPS_region==3 && OPS_2P0F && OPS_z_mass>60 && n_tight_jet > 1 && j1_pt > 50 && OPS_z_mass<120 && OPS_l1_pt>30 && OPS_l2_pt>20 && OPS_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && nHad_tau==0&& abs(OPS_l1_eta)<2.4 && abs(OPS_l2_eta)<2.4"
      SS_filters="ttc_region==3 && ttc_2P0F && ttc_mll>%f && ttc_mll<%f && MET_T1Smear_pt < 50 && n_tight_jet <3 && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_BadPFMuonFilter && ttc_l1_pt>20 && ttc_l2_pt>20 && abs(ttc_l1_eta)<2.4 && abs(ttc_l2_eta)<2.4&& nHad_tau==0"%((SS_Zmass-SS_width),(SS_Zmass+SS_width))
    else:
      OS_filters="n_tight_ele==1 && MET_T1_pt > 20 && n_tight_jet>1 && j1_pt > 50 && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_BadPFMuonFilter && OPS_l1_pt>20 && OPS_l2_pt>20 && abs(OPS_l1_eta)<2.4 && abs(OPS_l2_eta)<2.4"
#      OS_filters="OPS_region==3 && OPS_2P0F && OPS_z_mass>60 && OPS_z_mass<120 && n_tight_jet > 1 && j1_pt > 50 && OPS_l1_pt>30 && OPS_l2_pt>20 && OPS_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && nHad_tau==0 && abs(OPS_l1_eta)<2.4 && abs(OPS_l2_eta)<2.4"
      SS_filters="ttc_region==3 && ttc_2P0F && ttc_mll>%f && ttc_mll<%f && MET_T1_pt < 50 && n_tight_jet <3 && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_BadPFMuonFilter && ttc_l1_pt>20 && ttc_l2_pt>20 && abs(ttc_l1_eta)<2.4 && abs(ttc_l2_eta)<2.4 && nHad_tau==0"%((SS_Zmass-SS_width),(SS_Zmass+SS_width))
...
###############
  ...
  df_OS = df_OS.Define("j1_CvL","(tightJets_id_in24[0]!=-1) ? Jet_btagDeepFlavCvL[tightJets_id_in24[0]] : -1");
  df_SS = df_SS.Define("j1_CvL","(tightJets_id_in24[0]!=-1) ? Jet_btagDeepFlavCvL[tightJets_id_in24[0]] : -1");
  df_OS = df_OS.Define("j1_CvB","(tightJets_id_in24[0]!=-1) ? Jet_btagDeepFlavCvB[tightJets_id_in24[0]] : -1");
  df_SS = df_SS.Define("j1_CvB","(tightJets_id_in24[0]!=-1) ? Jet_btagDeepFlavCvB[tightJets_id_in24[0]] : -1");
  df_OS = df_OS.Define("j1_CHEmEF","(tightJets_id_in24[0]!=-1) ? Jet_chEmEF[tightJets_id_in24[0]] : -1");
  df_SS = df_SS.Define("j1_CHEmEF","(tightJets_id_in24[0]!=-1) ? Jet_chEmEF[tightJets_id_in24[0]] : -1");
  ...
  if isMC:
    ...
    for i in OS_hists_name:
      df_histo = df_OS_tree.Histo1D(('OS_'+i,'',histos_bins[i][0],histos_bins[i][1],histos_bins[i][2]), i,'genweight_shape')
      histos.append(df_histo.GetValue().Clone())
    df_histo = df_OS_tree.Histo1D(('OS_j1_CvsL_pre','',20,0,1),'j1_CvL','genweight')
    histos.append(df_histo.GetValue().Clone())
    df_histo = df_OS_tree.Histo1D(('OS_j1_CvsB_pre','',20,0,1),'j1_CvB','genweight')
    histos.append(df_histo.GetValue().Clone())


    for i in SS_hists_name:
      df_histo = df_SS_tree.Histo1D(('SS_'+i,'',histos_bins[i][0],histos_bins[i][1],histos_bins[i][2]), i,'genweight_shape')
      histos.append(df_histo.GetValue().Clone())
    df_histo = df_SS_tree.Histo1D(('SS_j1_CvsL_pre','',20,0,1),'j1_CvL','genweight')
    histos.append(df_histo.GetValue().Clone())
    df_histo = df_SS_tree.Histo1D(('SS_j1_CvsB_pre','',20,0,1),'j1_CvB','genweight')
    histos.append(df_histo.GetValue().Clone())
    ...
    df_histo = df_OS_tree.Histo1D(('OS_j1_CvsL_pre','',20,0,1),'j1_CvL')
    histos.append(df_histo.GetValue().Clone())
    df_histo = df_OS_tree.Histo1D(('OS_j1_CvsB_pre','',20,0,1),'j1_CvB')
    histos.append(df_histo.GetValue().Clone())

    for i in SS_hists_name:
      df_data_histo = df_SS_tree.Histo1D(('SS_'+i,'',histos_bins[i][0],histos_bins[i][1],histos_bins[i][2]), i)
      histos.append(df_data_histo)
    df_histo = df_SS_tree.Histo1D(('SS_j1_CvsL_pre','',20,0,1),'j1_CvL')
    histos.append(df_histo.GetValue().Clone())
    df_histo = df_SS_tree.Histo1D(('SS_j1_CvsB_pre','',20,0,1),'j1_CvB')
    histos.append(df_histo.GetValue().Clone())
