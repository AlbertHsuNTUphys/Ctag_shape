...
def select_MC_event(df_MC_tree, add_trigger_SF, add_chargeflip_SF, shift, filters, isOS, era, process):
  ...
  if era == '2017':
    df_MC_tree = df_MC_tree.Define("CtagSF","CtagSF(n_tight_jet,tightJets_id_in24,Jet_puId, Jet_pt_nom, Jet_hadronFlavour,Jet_btagDeepFlavCvL,Jet_btagDeepFlavCvB)");
  ...
  df_MC_tree = df_MC_tree.Define("genweight_shape","genweight*CtagSF")
